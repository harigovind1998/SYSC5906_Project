...
entity extend_matrix_control_s_axi is
generic (
...
end entity extend_matrix_control_s_axi;
...
architecture behave of extend_matrix_control_s_axi is
    ...
    constant ADDR_P_DATA_0               : INTEGER := 16#5c#;
    constant ADDR_P_CTRL                 : INTEGER := 16#60#;
    constant ADDR_B_DATA_0               : INTEGER := 16#64#;
    constant ADDR_B_DATA_1               : INTEGER := 16#68#;
    constant ADDR_B_CTRL                 : INTEGER := 16#6c#;
    constant ADDR_WB_DATA_0              : INTEGER := 16#70#;
    constant ADDR_WB_CTRL                : INTEGER := 16#74#;
    constant ADDR_HB_DATA_0              : INTEGER := 16#78#;
    constant ADDR_HB_CTRL                : INTEGER := 16#7c#;
