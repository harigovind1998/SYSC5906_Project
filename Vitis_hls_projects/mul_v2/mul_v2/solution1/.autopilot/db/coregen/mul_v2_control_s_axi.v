...
localparam
    ...
    ADDR_IER        = 7'h08,
    ADDR_ISR        = 7'h0c,
    ADDR_INP_DATA_0 = 7'h10,
    ADDR_INP_DATA_1 = 7'h14,
    ADDR_INP_CTRL   = 7'h18,
    ADDR_WI_DATA_0  = 7'h1c,
    ADDR_WI_CTRL    = 7'h20,
    ADDR_HI_DATA_0  = 7'h24,
    ADDR_HI_CTRL    = 7'h28,
    ADDR_CI_DATA_0  = 7'h2c,
    ADDR_CI_CTRL    = 7'h30,
    ADDR_WK_DATA_0  = 7'h34,
    ADDR_WK_CTRL    = 7'h38,
    ADDR_NK_DATA_0  = 7'h3c,
    ADDR_NK_CTRL    = 7'h40,
    ADDR_O_DATA_0   = 7'h44,
    ADDR_O_DATA_1   = 7'h48,
    ADDR_O_CTRL     = 7'h4c,
    ADDR_WO_DATA_0  = 7'h50,
    ADDR_WO_CTRL    = 7'h54,
    ADDR_HO_DATA_0  = 7'h58,
    ADDR_HO_CTRL    = 7'h5c,
    ADDR_CO_DATA_0  = 7'h60,
    ADDR_CO_CTRL    = 7'h64,
    ADDR_S_DATA_0   = 7'h68,
    ADDR_S_CTRL     = 7'h6c,
    WRIDLE          = 2'd0,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INP_DATA_0: begin
                    rdata <= int_Inp[31:0];
                end
                ADDR_INP_DATA_1: begin
                    rdata <= int_Inp[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_INP_DATA_0)
            int_Inp[31:0] <= (WDATA[31:0] & wmask) | (int_Inp[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_INP_DATA_1)
            int_Inp[63:32] <= (WDATA[31:0] & wmask) | (int_Inp[63:32] & ~wmask);
    end
end
