...
entity mul_v2_control_s_axi is
generic (
...
end entity mul_v2_control_s_axi;
...
architecture behave of mul_v2_control_s_axi is
    ...
    constant ADDR_INP_DATA_0 : INTEGER := 16#10#;
    constant ADDR_INP_DATA_1 : INTEGER := 16#14#;
    constant ADDR_INP_CTRL   : INTEGER := 16#18#;
    constant ADDR_WI_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_WI_CTRL    : INTEGER := 16#20#;
    constant ADDR_HI_DATA_0  : INTEGER := 16#24#;
    constant ADDR_HI_CTRL    : INTEGER := 16#28#;
    constant ADDR_CI_DATA_0  : INTEGER := 16#2c#;
    constant ADDR_CI_CTRL    : INTEGER := 16#30#;
    constant ADDR_WK_DATA_0  : INTEGER := 16#34#;
    constant ADDR_WK_CTRL    : INTEGER := 16#38#;
    constant ADDR_NK_DATA_0  : INTEGER := 16#3c#;
    constant ADDR_NK_CTRL    : INTEGER := 16#40#;
    constant ADDR_O_DATA_0   : INTEGER := 16#44#;
    constant ADDR_O_DATA_1   : INTEGER := 16#48#;
    constant ADDR_O_CTRL     : INTEGER := 16#4c#;
    constant ADDR_WO_DATA_0  : INTEGER := 16#50#;
    constant ADDR_WO_CTRL    : INTEGER := 16#54#;
    constant ADDR_HO_DATA_0  : INTEGER := 16#58#;
    constant ADDR_HO_CTRL    : INTEGER := 16#5c#;
    constant ADDR_CO_DATA_0  : INTEGER := 16#60#;
    constant ADDR_CO_CTRL    : INTEGER := 16#64#;
    constant ADDR_S_DATA_0   : INTEGER := 16#68#;
    constant ADDR_S_CTRL     : INTEGER := 16#6c#;
    ...
    signal int_Inp             : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_INP_DATA_0 =>
                        rdata_data <= RESIZE(int_Inp(31 downto 0), 32);
                    when ADDR_INP_DATA_1 =>
                        rdata_data <= RESIZE(int_Inp(63 downto 32), 32);
                    when ADDR_WI_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INP_DATA_0) then
                    int_Inp(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_Inp(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INP_DATA_1) then
                    int_Inp(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_Inp(63 downto 32));
                end if;
            end if;
        end if;
    end process;
