...
initial begin
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram0);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram1);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram2);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram3);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram4);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram5);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram6);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram7);
    $readmemh("./mul_v2_mul_v2_Pipeline_XCL_WG_DIM_X_mul_v2_I.dat", ram8);
end
