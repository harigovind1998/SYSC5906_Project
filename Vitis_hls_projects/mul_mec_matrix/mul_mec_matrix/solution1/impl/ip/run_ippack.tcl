...
set Library     "hls"
set IPName      "mul_mec_matrix"
set Version     "1.0"
set DisplayName "Mul_mec_matrix"
set Revision    "2112081610"
...
set xo_kernel_name "mul_mec_matrix"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/University/Masters/Year_1/SYSC5906/SYSC5906_Project/Vitis_hls_projects/mul_mec_matrix/mul_mec_matrix/solution1"
set debug_dir "C:/University/Masters/Year_1/SYSC5906/SYSC5906_Project/Vitis_hls_projects/mul_mec_matrix/mul_mec_matrix/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {mul_mec_matrix_udiv_32ns_32ns_32_36_1
mul_mec_matrix_urem_32ns_32ns_32_36_1
mul_mec_matrix_mul_32s_32s_32_1_1
mul_mec_matrix_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "mul_mec_matrix"
set TopNoPrefix "mul_mec_matrix"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 group_id_x W 0x0 "Data signal of group_id_x" {{0 32 group_id_x W 0 "Bit 31 to 0 of group_id_x"}}} {0x18 group_id_y W 0x0 "Data signal of group_id_y" {{0 32 group_id_y W 0 "Bit 31 to 0 of group_id_y"}}} {0x20 group_id_z W 0x0 "Data signal of group_id_z" {{0 32 group_id_z W 0 "Bit 31 to 0 of group_id_z"}}} {0x28 global_offset_x W 0x0 "Data signal of global_offset_x" {{0 32 global_offset_x W 0 "Bit 31 to 0 of global_offset_x"}}} {0x30 global_offset_y W 0x0 "Data signal of global_offset_y" {{0 32 global_offset_y W 0 "Bit 31 to 0 of global_offset_y"}}} {0x38 global_offset_z W 0x0 "Data signal of global_offset_z" {{0 32 global_offset_z W 0 "Bit 31 to 0 of global_offset_z"}}} {0x40 I_1 W 0x0 "Data signal of I" {{0 32 I W 0 "Bit 31 to 0 of I"}}} {0x44 I_2 W 0x0 "Data signal of I" {{0 32 I W 0 "Bit 63 to 32 of I"}}} {0x4c wi W 0x0 "Data signal of wi" {{0 32 wi W 0 "Bit 31 to 0 of wi"}}} {0x54 hi W 0x0 "Data signal of hi" {{0 32 hi W 0 "Bit 31 to 0 of hi"}}} {0x5c ci W 0x0 "Data signal of ci" {{0 32 ci W 0 "Bit 31 to 0 of ci"}}} {0x64 K_1 W 0x0 "Data signal of K" {{0 32 K W 0 "Bit 31 to 0 of K"}}} {0x68 K_2 W 0x0 "Data signal of K" {{0 32 K W 0 "Bit 63 to 32 of K"}}} {0x70 wk W 0x0 "Data signal of wk" {{0 32 wk W 0 "Bit 31 to 0 of wk"}}} {0x78 nk W 0x0 "Data signal of nk" {{0 32 nk W 0 "Bit 31 to 0 of nk"}}} {0x80 O_1 W 0x0 "Data signal of O" {{0 32 O W 0 "Bit 31 to 0 of O"}}} {0x84 O_2 W 0x0 "Data signal of O" {{0 32 O W 0 "Bit 63 to 32 of O"}}} {0x8c wo W 0x0 "Data signal of wo" {{0 32 wo W 0 "Bit 31 to 0 of wo"}}} {0x94 ho W 0x0 "Data signal of ho" {{0 32 ho W 0 "Bit 31 to 0 of ho"}}} {0x9c co W 0x0 "Data signal of co" {{0 32 co W 0 "Bit 31 to 0 of co"}}} {0xa4 s W 0x0 "Data signal of s" {{0 32 s W 0 "Bit 31 to 0 of s"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "G:/dev_tools/xilinx/Vitis_HLS/2021.1/common/scripts/ipxhls.tcl"
