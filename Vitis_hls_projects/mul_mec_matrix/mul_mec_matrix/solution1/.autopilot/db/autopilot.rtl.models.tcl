set SynModuleInfo {
  {SRCNAME mul_mec_matrix_Pipeline_XCL_WG_DIM_X_L MODELNAME mul_mec_matrix_Pipeline_XCL_WG_DIM_X_L RTLNAME mul_mec_matrix_mul_mec_matrix_Pipeline_XCL_WG_DIM_X_L
    SUBMODULES {
      ...
      {MODELNAME mul_mec_matrix_mul_5s_32s_32_1_1 RTLNAME mul_mec_matrix_mul_5s_32s_32_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME mul_mec_matrix_mul_mec_matrix_Pipeline_XCL_WG_DIM_X_L_mul_mec_matrix_K RTLNAME mul_mec_matrix_mul_mec_matrix_Pipeline_XCL_WG_DIM_X_L_mul_mec_matrix_K BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
  ...
  {SRCNAME mul_mec_matrix MODELNAME mul_mec_matrix RTLNAME mul_mec_matrix IS_TOP 1
    SUBMODULES {
      {MODELNAME mul_mec_matrix_udiv_32ns_32ns_32_36_seq_1 RTLNAME mul_mec_matrix_udiv_32ns_32ns_32_36_seq_1 BINDTYPE op TYPE udiv IMPL auto_seq LATENCY 35 ALLOW_PRAGMA 1}
      ...
      {MODELNAME mul_mec_matrix_mul_6s_6s_6_1_1 RTLNAME mul_mec_matrix_mul_6s_6s_6_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME mul_mec_matrix_mac_mulsub_6s_6s_6ns_6_4_1 RTLNAME mul_mec_matrix_mac_mulsub_6s_6s_6ns_6_4_1 BINDTYPE op TYPE sub IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
