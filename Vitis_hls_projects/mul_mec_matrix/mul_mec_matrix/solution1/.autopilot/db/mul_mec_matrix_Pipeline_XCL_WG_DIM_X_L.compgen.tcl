...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_global_id_base_x \
    op interface \
    ports { global_id_base_x { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { shiftreg_out { O 192 vector } shiftreg_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_value_out \
    op interface \
    ports { value_out { O 32 vector } value_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName mul_mec_matrix_flow_control_loop_pipe_sequential_init_U
set CompName mul_mec_matrix_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix mul_mec_matrix_ \
}"
} else {
