...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = creat_mec_matrix
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = creat_mec_matrix_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = extend_matrix
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = extend_matrix_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mul_mec_matrix
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mul_mec_matrix_0
END
