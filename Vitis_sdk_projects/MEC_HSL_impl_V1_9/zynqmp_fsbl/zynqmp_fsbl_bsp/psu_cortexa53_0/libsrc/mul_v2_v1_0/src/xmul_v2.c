...
void XMul_v2_Set_Inp(XMul_v2 *InstancePtr, u64 Data) {
    ...
    XMul_v2_WriteReg(InstancePtr->Control_BaseAddress, XMUL_V2_CONTROL_ADDR_INP_DATA, (u32)(Data));
    XMul_v2_WriteReg(InstancePtr->Control_BaseAddress, XMUL_V2_CONTROL_ADDR_INP_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMul_v2_Get_Inp(XMul_v2 *InstancePtr) {
    ...
    Data = XMul_v2_ReadReg(InstancePtr->Control_BaseAddress, XMUL_V2_CONTROL_ADDR_INP_DATA);
    Data += (u64)XMul_v2_ReadReg(InstancePtr->Control_BaseAddress, XMUL_V2_CONTROL_ADDR_INP_DATA + 4) << 32;
    return Data;
}
