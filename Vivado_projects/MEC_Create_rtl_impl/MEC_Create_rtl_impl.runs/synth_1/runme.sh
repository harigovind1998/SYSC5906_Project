...
HD_PWD='C:/University/Masters/Year_1/SYSC5906/SYSC5906_Project/Vivado_projects/MEC_Create_rtl_impl/MEC_Create_rtl_impl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log norm2mec_matrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source norm2mec_matrix.tcl
