...
initial begin
    $readmemh("./mul_v2_mul_v2_filter.dat", ram0);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram1);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram2);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram3);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram4);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram5);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram6);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram7);
    $readmemh("./mul_v2_mul_v2_filter.dat", ram8);
end
