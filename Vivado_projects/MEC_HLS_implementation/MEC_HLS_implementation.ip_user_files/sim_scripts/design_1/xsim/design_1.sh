...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -L axi_vip_v1_1_10 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_10 -L xilinx_vip"
...
{
  file="xsim.ini"
  lib_map_path="G:/dev_tools/xilinx/Vivado/2021.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
