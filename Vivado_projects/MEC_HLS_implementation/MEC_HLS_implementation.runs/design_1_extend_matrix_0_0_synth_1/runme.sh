...
HD_PWD='C:/University/Masters/Year_1/SYSC5906/SYSC5906_Project/Vivado_projects/MEC_HLS_implementation/MEC_HLS_implementation.runs/design_1_extend_matrix_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_extend_matrix_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_extend_matrix_0_0.tcl
